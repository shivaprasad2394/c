...
+--------------------------------------------------------------+
| IP Layer (DHCP, APIPA, NAT, mDNS) |
+--------------------------------------------------------------+
| WPA2-PSK / WPA3-SAE Authentication (Provisioning) |
+--------------------------------------------------------------+
| P2P Management Layer (GO Negotiation, Discovery, etc.) |
+--------------------------------------------------------------+
| 802.11 MAC Layer (Mgmt/Data/Control) |
+--------------------------------------------------------------+
| PHY Layer (2.4/5 GHz Wi-Fi Radios) |
+--------------------------------------------------------------+
